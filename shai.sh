...
function start_mining() {
    ...
    read wallet_address
    echo "正在启动挖矿..."
    ./src/shaicoind -miningaddress=$wallet_address -addnode=51.161.117.199:42069 -addnode=139.60.161.14:42069 -addnode=149.50.101.189:21026 -addnode=3.21.125.80:42069 > "$LOG_FILE" 2>&1 &
